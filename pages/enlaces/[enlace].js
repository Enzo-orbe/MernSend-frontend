...
export default ({ enlace }) => {
    ...
    return (
        <Layout>
            {tienePassword ? (
                <>
                    <p className="text-center">Este enlace tiene password, colocalo a continuacion:</p>
                    ...
                    <>
                        ...
                        <div className="flex items-center justify-center mt-10">
                            <a href={`${process.env.backendURL}/api/archivos/${enlace.archivo}`} className="bg-red-500 text-center py-3 px-10 rounded uppercase font-bold text-white cursor-pointer">Aqui</a>
                        </div>
                    </>
                )}
