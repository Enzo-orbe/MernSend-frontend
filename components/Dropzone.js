...
const Dropzone = () => {
    ...
    return (
        <div className="md:flex-1 mb-3 mx-2 mt-16 lg:my-0 flex flex-col items-center justify-center border-dashed border-gray-400 border-2 bg-gray-100 px-4">
            {acceptedFiles.length > 0 ? (
                <div className="mt-10 w-full">
                    ...
                    {cargando ? <p className="my-10 text-center text-gray-600">Subiendo Archivo</p> :
                        <button
                            type="button"
                            className="bg-blue-700 w-full py-3 rounded-lg text-white my-10 mx-auto hover:bg-blue-800"
                            onClick={() => crearEnlace()}
                        >Crear Enlace</button>}
                    ...
                    <div {...getRootProps({ className: "dropzone w-full py-32" })}>
                        ...
                        {isDragActive ? <p className="text-2xl text-center text-gray-600">Suelta el archivo</p> :
                            <div className="text-center">
                                ...
                                <button className="bg-blue-700 w-full py-3 rounded-lg text-white my-10 mx-auto hover:bg-blue-800" type="button">
